        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Meet <span className="gradient-text">essence</span>
              <br />
              your furry Discord moderation bot!
            </h1>
            <p className="text-gray-300 text-lg mb-8">
              Welcome essence to your server! Your all in one furro bot :3
              <br />
              Enhance your server with powerful moderation, fun commands, and
              music capabilities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <a
                  href="https://discord.com/oauth2/authorize?client_id=1358670250799005797&permissions=27497939970230&response_type=code&redirect_uri=https%3A%2F%2Fessencedsc.netlify.app%2Fthank-you&integration_type=0&scope=identify+bot+applications.commands"
                  target="_blank"
