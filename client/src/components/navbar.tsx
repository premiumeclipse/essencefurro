      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#commands" className="text-gray-300 hover:text-white transition-colors">
              Commands
            </a>
        ...
        <div className={cn("md:hidden pb-4", isMenuOpen ? "block" : "hidden")}>
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-3 pt-2">
              <Button 
                className="bg-[#5865F2] hover:bg-[#4752c4] transition-transform hover:-translate-y-0.5 hover:shadow-lg w-full"
                asChild
              >
                <a href="https://discord.com/api/oauth2/authorize" target="_blank" rel="noopener noreferrer">
                  Add Bot
              ...
              <Button 
                variant="outline" 
                className="transition-transform hover:-translate-y-0.5 hover:shadow-lg w-full"
                asChild
              >
                <a href="https://discord.gg/essencesupport" target="_blank" rel="noopener noreferrer">
                  Join Server
